...
2. **预建四个象限目录**，这是对 Diátaxis 官方建议的**有意偏离**。偏离的代价以"每个象限放一份 `README.md` landing page"来抵消：目录因此**不是空结构**，而是一份写明清收范围与象限边界的导航页。
3. 象限 `README.md` 中明确"本象限暂无内容"，避免贡献者误判为未完成。
...
- 空象限存在被误读为"没做完"的风险，靠 `README.md` 文案缓解。
